...
import 'package:first_page/SecurityCheck_Screen.dart';

import 'package:first_page/loading.dart';
  ...
  void _showGovernoratesBottomSheet() {
    showModalBottomSheet(
      ...
      builder: (_) => Container(
        ...
        child: Column(
          children: [
            const Text("Choose your Governorate",
      ...
      appBar: AppBar(
        ...
        actions: [
          TextButton(
            ...
            child:
                const Text("Skip", style: TextStyle(color: Color(0xff001F3F))),
          )
        ],
      ),
      body: Padding(
          ...
          child: ListView(
            children: [
              _buildTextField(fullNameController,
                  "Full Name as in the National ID", "Enter full name",
                  isName: true),
              _buildTextField(nationalNumberController, "National Number",
              ...
              Row(
                children: [
                    ...
                    child: GestureDetector(
                      ...
                      child: AbsorbPointer(
                        child: _buildTextField(
                            countryController, "", "Select Governorate"),
                      ),
                    ),
                  ),
                  const SizedBox(width: 10),
                  Expanded(
                      child: _buildTextField(
                          postalCodeController, "", "5-digits",
                          isPostalCode: true)),
                ],
              ),
              _buildTextField(
                  address1Controller, "Physical Address 1", "Full address"),
    ...
    return Padding(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        TextFormField(
          ...
          keyboardType: isNationalNumber || isPhoneNumber || isPostalCode
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            suffixIcon:
                const Icon(Icons.calendar_today, color: Color(0xff082347)),
            filled: true,
            fillColor: Colors.grey.shade100,
            border: OutlineInputBorder(borderRadius: BorderRadius.circular(8)),
          ),
