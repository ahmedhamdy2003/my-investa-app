...
class LegallyBound extends StatelessWidget {
  const LegallyBound({super.key});
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Before investing, you sign a digital contract that protects your rights, outlines your expected returns, and clearly defines what happens in case of delays or failure.',
              style: TextStyle(
                fontSize: 16,
                height: 1.5,
