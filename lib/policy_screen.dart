// policy_screen.dart
import 'package:first_page/greatB_screen.dart';
        ...
        children: [
          const SizedBox(
            ...
            child: Icon(Icons.circle,
                size: 8, color: Color(0xFF5E6D7B)), // نقطة صغيرة
          ),
          Expanded(
            child: Text(
              text,
