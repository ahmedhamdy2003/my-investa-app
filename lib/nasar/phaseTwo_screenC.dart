...
import 'package:investa4/nasar/phaseTwo_screenD.dart'; // Navigation to the next screen
...
class _PhaseTwoScreenCState extends State<PhaseTwoScreenC> {
  ...
  Map<String, dynamic> _collectAndMergeData() {
    Map<String, dynamic> currentScreenData = {
      ...
      // The userId is already part of widget.allCollectedData if passed from PhaseTwoScreenB,
